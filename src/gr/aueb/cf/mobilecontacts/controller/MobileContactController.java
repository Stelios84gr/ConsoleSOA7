...
public class MobileContactController {
    ...
    private final IMobileContactDAO dao = new MobileContactDAOImpl();   // το δημιουργεί για να δοθεί στο MobileContactServiceImpl (DI)
    ...
    public String insertContact(MobileContactInsertDTO insertDTO) {
        ...
        try {
            ...
            if (!errorVector.isEmpty()) {           // if (!error.equals("")
                return "Error.\n" + "Validation error\n" + errorVector;
            }
    ...
    public String deleteContactById(Long id) throws ContactNotFoundException {
        try {
    ...
    public String getContactById(Long id) throws ContactNotFoundException {
        MobileContact mobileContact;
        MobileContactReadOnlyDTO readOnlyDTO;
        try {
    ...
    public String getContactByPhoneNumber(String phoneNumber) throws ContactNotFoundException {
        MobileContact mobileContact;
        MobileContactReadOnlyDTO readOnlyDTO;
        try {
    ...
    public String deleteContactByPhoneNumber(String phoneNumber) throws ContactNotFoundException {
        try {
            service.deleteContactByPhoneNumber(phoneNumber);
            return "OK. Η επαφή διαγράφτηκε.";
        } catch (ContactNotFoundException e) {
            return "Error.\n" + "Λάθος κατά τη διαγραφή. Η επαφή δεν βρέθηκε.";
        }
    }
